/*
*
* S1 Baseband Processor application specific definitions
*
* created: 14.03.15
*
*/
...
#define BLE_ENDPOINTS {								\
	...
	/* BLE_IMPORT_ENDPOINT(gap_name, DEVICE_NAME),	*/ \
	BLE_IMPORT_ENDPOINT(i2c_control, I2C_CONTROL),	\
	BLE_IMPORT_ENDPOINT(i2c_data, I2C_DATA),		\
	BLE_DFU_SERVICE									\
}
...
#define BLE_MAIN_SERVICE	UUID_FLIGHT_SERVICE
#define BLE_DEVICE_NAME		"S1 Prototype"
//#define BLE_CUSTOM_DEVICE_NAME	todo: implement
